...
# Installer doctrine-fixtures-bundle et charger les fixtures
RUN <<-EOF
    mkdir -p var/cache var/log var/share
    
    # Installer le bundle des fixtures (en production aussi)
    composer require doctrine/doctrine-fixtures-bundle --no-interaction --no-scripts
