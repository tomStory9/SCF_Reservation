...
class UserFixtures extends Fixture
{
    ...
    {
        $admin = new User();
        $admin->setName('SCF_ADMIN');
        $admin->setEmail('admin@test.test');
        $admin->setPassword(password_hash('password', self::DEFAULT_PASSWORD));
        ...
        $ca_user->setPassword(password_hash('password', self::DEFAULT_PASSWORD));
        ...
        $aa_user->setPassword(password_hash('password', self::DEFAULT_PASSWORD));
        ...
        $fa_user->setPassword(password_hash('password', self::DEFAULT_PASSWORD));
        ...
        $tm_user->setPassword(password_hash('password', self::DEFAULT_PASSWORD));
        ...
        $default_user->setPassword(password_hash('password', self::DEFAULT_PASSWORD));
