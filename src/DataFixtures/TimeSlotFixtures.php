...
class TimeSlotFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $h9->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h9);
        ...
        $h10->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h10);
        ...
        $h11->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h11);
        ...
        $h12->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h12);
        ...
        $h13->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h13);
        ...
        $h14->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h14);
        ...
        $h15->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h15);
        ...
        $h16->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h16);
        ...
        $h17->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h17);
        ...
        $h18->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h18);
        ...
        $h19->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h19);
        ...
        $h20->setPeriod(TimeSlotPeriod::HOURLY);
        $manager->persist($h20);
        ...
        $apres_midi->setPeriod(TimeSlotPeriod::AFTERNOON);
        ...
        $soir->setPeriod(TimeSlotPeriod::EVENING);
